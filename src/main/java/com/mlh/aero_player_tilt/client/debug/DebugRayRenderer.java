...
public class DebugRayRenderer {
    ...
    public static void onRenderLevel(RenderLevelStageEvent event) {
        ...
        if (!Config.DEBUG_RAYS.get() || pendingRays.isEmpty()) return;
    ...
    private static void drawLine(VertexConsumer vc, Matrix4f mat, DebugRay ray) {
        ...
        vc.addVertex(mat, x1, y1, z1).setColor(ray.r(), ray.g(), ray.b(), 1f).setNormal(nx, ny, nz);
        vc.addVertex(mat, x2, y2, z2).setColor(ray.r(), ray.g(), ray.b(), 1f).setNormal(nx, ny, nz);
    }
}
